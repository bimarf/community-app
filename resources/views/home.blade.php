        ...
        <nav class="navbar navbar-dark navbar-expand-lg bg-primary">
            <div class="container flex justify-content-between">
                <a class="navbar-link" href="{{ route('home') }}">
                    <img class="h-32px" src="{{ url('assets/images/logo.png') }}" alt="Laracuss">
                </a>
                            ...
                            <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-5 col-lg-7">
                                        ...
                                        <span class="fs-12px">
                                            <a class="me-1 fw-bold" href="#">Bima Rengga
                                            </a>
                                            <span class="color-gray text-nowrap">2 hours ago</span>
                                        </span>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-6 mb-5 mb-lg-0">
                    <img src="{{ url('assets/images/dark-logo.png') }}" alt="Laracuss logo" class="h-32px mb-4">

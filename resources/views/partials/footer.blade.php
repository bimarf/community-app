    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-lg-6 mb-5 mb-lg-0">
                <img src="{{ url('assets/images/logo.png') }}" alt="Media Discuss logo" class="h-32px mb-4">
                ...
                <div class="d-flex flex-column flex-lg-row justify-content-end">
                    <div class="d-flex flex-column me-140px mb-3 mb-lg-0">
                        ...
                        <ul class="list-unstyled">
                            <li class="text-white"><a href="mailto:hi@mediadiscuss.com">hi@mediadiscuss.com</a></li>
                        </ul>
                    </div>

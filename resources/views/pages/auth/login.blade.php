                        ...
                        <form action="{{ route('login.post') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="password" class="form-control border-end-0 pe-0 rounded-0 rounded-start @error('password') is-invalid @enderror @error('credentials') is-invalid @enderror"
                                        id="password" name="password">
                                    <span class="input-group-text bg-white border-start-0 pe-auto @error('password') border-danger rounded-end @enderror @error('credentials') border-danger rounded-end @enderror">

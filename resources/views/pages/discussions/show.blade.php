        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 col-lg-8 mb-5 mb-lg-0">
                                ...
                                <div class="row align-items-start justify-content-between">
                                    <div class="col">
                                        <span class="color-gray me-2">
                                            ...
                                            <input type="text" value="{{ url('discussion/show') }}" id="current-url"
                                                class="d-none">
                                        </span>
                                    </div>
                    ...
                    <div class="fw-bold text-center">Please <a href="{{ route('login') }}" class="text-primary">sign
                            in</a> or <a href="{{ route('sign-up') }}" class="text-primary">
